...
\namesection{}{Avantika Mudumbai}{ % Your name
...
\descript{Bangalore\\Integrated MTech. in CSE}
\location{2019 - Present\\ CGPA: 3.25/4}


\sectionspace % Some whitespace after the section
\subsection{Fiitjee Junior College}
\descript{Hyderabad\\Senior Secondary Education}
\location{2017-2019\\TSBIE: 92\%}

\sectionspace % Some whitespace after the section
%------------------------------------------------

\subsection{Chirec International}
\descript{Hyderabad\\Highschool}
\location{2015-2017\\CGPA: 10/10}
...
GitLab:// \href{https://gitlab.com/avantikaaa	}{\bf avantikaaa} \\
LinkedIn:// \href{https://www.linkedin.com/in/avantika-mudumbai-ba31171a6/}{\bf Avantika Mudumbai} \\
Facebook:// \href{https://www.facebook.com/avantika.mudumbai/}{\bf Avantika Mudumbai}
Twitter:// \href{https://twitter.com/__avantika}{\bf @\_\_avantika} \\
