...
\documentclass[a4]{deedy-resume-openfont}
...
\namesection{}{Avantika Mudumbai}{
\urlstyle{same}\url{https://gitlab.com/avantikaaa} \\ % Your website, LinkedIn profile or other web address
\href{mailto:avantika.mudumbai@iiitb.org}{avantika.mudumbai@iiitb.org} | +91 8179640318 % Your contact information
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Contact} 
\href{mailto:avantika.mudumbai@iiitb.org}{\faEnvelope{ avantika.mudumbai@iiitb.org}} \\
%\hspace{2pt} 
\href{https://www.linkedin.com/in/avantika-mudumbai-ba31171a6//}{\faLinkedinSquare{ Avantika Mudumbai}}\\
\href{https://gitlab.com/avantikaaa}{\faGithub{ avantikaaa}} \\
\href{https://twitter.com/__avantika}{\faTwitter{ @\_\_avantika}} \\
\sectionsep
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Education} 
\subsection{International Institute of Information \\Technology}
\descript{Bangalore\\Integrated MTech in CSE\\2019 - Present}
\location{CGPA: 3.25/4}
\sectionsep

\subsection{Fiitjee Junior College}
\descript{Hyderabad\\Senior Secondary Education\\2017-2019}
\location{TSBIE: 92\%}
\sectionsep

\subsection{Chirec International}
\descript{Hyderabad\\Highschool\\2015-2017}
\location{CGPA: 10/10}
\sectionsep
